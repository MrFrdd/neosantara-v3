...
class JawaBaratPage extends StatelessWidget {
  ...
  Widget _buildContentSection({
    ...
    String? imageUrl, // Tambahkan parameter opsional untuk URL gambar
  }) {
    ...
    // Tentukan spasi akhir. Jika hanya menampilkan gambar, spasi akhirnya sedikit dikurangi.
    ...
    return Column(
      ...
      children: [
        ...
        if (content.isNotEmpty) const SizedBox(height: 10), // Spasi antara teks dan gambar/end

        // Menampilkan gambar jika imageUrl tidak null
        if (imageUrl != null) ...[
          ...
          Center(
            child: ClipRRect(
              ...
              child: Image.asset(
                imageUrl,
                width: double.infinity, // Gambar mengisi lebar yang tersedia
  ...
  Widget _buildCommentSection({required bool isMobile}) {
    // Menggunakan list kosong karena mockComments telah dihapus
    final List<Comment> currentComments = const [];

    final commentList = Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: currentComments.isEmpty
          ? [
              Padding(
  ...
  Widget build(BuildContext context) {
    ...
    final String eraKolonialParagraf1 =
    ...
    final String eraKemerdekaanAwal =
    ...
    final String administrasiModern =
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildContentSection(
                            title: "", 
                            content: "", // Hanya menampilkan gambar
                            isMobile: isMobile,
                          ...
                          _buildContentSection(
                            ...
                            isMobile: isMobile,
                            imageUrl: null, // Pastikan tidak ada gambar ganda
                          ),
